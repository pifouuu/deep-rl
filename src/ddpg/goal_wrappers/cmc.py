...
class CmcNoGoal(no_goal):
    def __init__(self, env, reward_type, epsilon):
        super(CmcNoGoal, self).__init__(env, reward_type, epsilon)
...
class CmcPos(goal_basic):
    def __init__(self, env, reward_type, epsilon):
        super(CmcPos, self).__init__(env, reward_type, epsilon)
...
class CmcFull(goal_basic):
    def __init__(self, env, reward_type, epsilon):
        super(CmcFull, self).__init__(env, reward_type, epsilon)
