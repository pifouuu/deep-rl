...
class TestAlgorithmicEnvInteractions(unittest.TestCase):
    ...
    CANNED_INPUT = [0, 1]
    ENV_KLS = gym.envs.algorithmic.copy_.CopyEnv
    ...
    def test_grid_naviation(self):
        env = gym.envs.algorithmic.reversed_addition.ReversedAdditionEnv(rows=2, base=6)
    ...
    def test_grid_success(self):
        env = gym.envs.algorithmic.reversed_addition.ReversedAdditionEnv(rows=2, base=3)
        canned = [ [1, 2], [1, 0], [2, 2] ]
        imprint(env, canned)
        obs = env.reset()
        target = [0, 2, 1, 1]
...
class TestTargets(unittest.TestCase):
    ...
    def test_reverse_target(self):
        ...
        env = gym.envs.algorithmic.reverse.ReverseEnv()
    ...
    def test_reversed_addition_target(self):
        env = gym.envs.algorithmic.reversed_addition.ReversedAdditionEnv(base=3)
        input_expected = [
            ([[1,1], [1,1]], [2, 2]),
            ([[2,2], [0,1]], [1, 2]),
    ...
    def test_reversed_addition_3rows(self):
        env = gym.envs.algorithmic.reversed_addition.ReversedAdditionEnv(base=3, rows=3)
        input_expected = [
            ([[1,1,0],[0,1,1]], [2, 2]),
            ([[1,1,2],[0,1,1]], [1,0,1]),
        ]
...
class TestInputGeneration(unittest.TestCase):
    ...
    def test_duplicatedinput_inputs(self):
        ...
        env = gym.envs.algorithmic.duplicated_input.DuplicatedInputEnv(duplication=3)
